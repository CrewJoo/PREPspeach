...
export async function POST(req: Request) {
    ...
    const contextPrompt = mode === 'SCHOOL'
        ? "당신은 입학사정관입니다. 학생의 잠재력과 학업 의지를 파악해야 합니다."
        : "당신은 20년차 대기업 인사담당자입니다. 지원자의 직무 역량과 조직 적합성을 파악해야 합니다.";
    ...
    3. TREND (시대 흐름 - 통찰력): 사회/기술 변화와 본인의 역할 연결.
    4. STAND (가치관 - 철학): 확고한 자기 기준과 직업윤리.
    5. DIFFERENT (차별화 - 고유성): 대체 불가능한 자신만의 무기.
