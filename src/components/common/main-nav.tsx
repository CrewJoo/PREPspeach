    ...
    return (
        <>
            <div className="fixed top-6 left-0 z-[100] w-full p-4 flex justify-center pointer-events-none">
                <nav className="pointer-events-auto w-full max-w-6xl bg-white/90 backdrop-blur-sm border border-white/50 rounded-full shadow-md px-6 py-4 sm:px-8 sm:py-5 flex justify-between items-center ring-1 ring-white/60 transition-all hover:bg-white/95 hover:shadow-lg">
