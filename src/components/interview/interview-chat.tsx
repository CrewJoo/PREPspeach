...
export function InterviewChat() {
    ...
    const [initialMessages] = useState(() => {
        ...
        const initialGreeting = mode === 'SCHOOL'
            ? "안녕하세요! 입학사정관입니다. 학생기록부만으로는 알 수 없는 학생만의 진짜 이야기를 듣고 싶어서 모셨습니다. 긴장하지 마시고 편하게 대화해요. 우선, 어떤 전공이나 진로를 꿈꾸고 계신가요?"
            : "반갑습니다. 오늘 면접을 진행하게 된 인사담당자입니다. 이력서에 적힌 화려한 스펙보다는, 지원자님이 어떤 가치관을 가진 사람인지 깊이 알고 싶습니다. 먼저, 우리 직무에 지원하게 된 솔직한 계기가 궁금합니다.";
            ...
            <div className="p-4 bg-white border-t border-gray-200">
                <form onSubmit={handleSendMessage} className="relative flex items-end gap-2">
                    <Textarea
                        ...
                        placeholder={isLoading ? "면접관이 말하고 있습니다..." : "답변을 입력하세요..."}
